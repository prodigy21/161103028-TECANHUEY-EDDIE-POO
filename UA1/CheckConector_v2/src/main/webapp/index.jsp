...
<%
        ...
        %><tr>
            ...
            <td><%out.print(rs.getString("anioNacimiento"));%></td>
            <td><a class="btn btn-warning btn-block" href="formularioUsuario.jsp?id=<%=rs.getString("id_usuario")%>">Editar Usuario</a></td>
        <td><a class="btn btn-danger btn-block" href="Id">Eliminar Usuario</a></td></tr><%
            }%>
    </table>
<%
    }
